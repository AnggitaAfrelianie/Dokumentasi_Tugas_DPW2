...
use App\Models\tags;
use App\Http\Controllers\keyword;
use Auth;
...
class PostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post = Posts::where('id', 'LIKE', '%'.$keyword.'%' )
        ->orWhere('judul','LIKE', '%'.$keyword.'%')
        ->orWhere('content','LIKE', '%'.$keyword.'%')
        ->orWhere('users_id','LIKE', '%'.$keyword.'%')
        ->orWhere('slug','LIKE', '%'.$keyword.'%')
        ->paginate(10);
        return view('admin.post.index', compact('post', 'keyword'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success','Post Berhasil Dihapus (tersimpan ditrashed post)');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success','Post Berhasil Direstore (tersimpan list post)');
    }
